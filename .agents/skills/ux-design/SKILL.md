...
**If no argument is provided**, do not fail - ask instead in plain text:
...
2. **Questions**: Ask what is needed to draft this section. Use plain-text options
...
Explain reasoning in conversation, then ask the user to make the decision in plain text.
...
- Ask in plain text: "Do you want an ASCII wireframe as part of this spec?"
...
Ask in plain text about any open questions on accessibility tier:
...
Ask in plain text and step through items in groups of 3-4, not all at once.
