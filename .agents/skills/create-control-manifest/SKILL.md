...
Spawn `technical-director` via spawn_agent using gate **TD-MANIFEST** (`.agents/docs/director-gates.md`).
...
- **CONCERNS** → surface in plain text with options: `Revise flagged rules` / `Accept and proceed` / `Discuss further`
