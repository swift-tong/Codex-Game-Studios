...
If the project appears fresh (no artifacts at all), ask in plain text:
...
**If it does not exist**: Ask in plain text:
...
and offer to handle it immediately using plain-text options. Choose the first
branch that applies:
