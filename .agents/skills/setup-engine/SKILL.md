...
user-invocable: true
allowed-tools: Read, Glob, Grep, Write, Edit, WebSearch, WebFetch, spawn_agent
---
...
**Question 1 — Prior experience** (ask this first, always, in plain text):
...
**Question 2 — Target platform** (ask this second, always, in plain text — platform eliminates or heavily weights engines before any other factor):
...
5. Ask in plain text: "Does this recommendation feel right, or would you like to explore a different engine?"
...
Ask in plain text which concept-specific deep-dive topics the user wants to explore. Always generate these options from the user's actual concept and do not use generic filler options. Always include at minimum:
...
### Remaining Sections
- **Performance Budgets**: Ask in plain text:
