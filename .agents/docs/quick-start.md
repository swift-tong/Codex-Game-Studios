# Codex Game Studios -- Quick Start Guide

## What Is This?

This is a Codex-first game development architecture. It
...
**Don't know where to begin?** Invoke `$start`. It asks where you are and routes
